import { Character } from "@/dragon-ball/Index";
...
// volver statica las paginas
export async function generateStaticParams() {
    const static58Characters = Array.from({length: 58}).map((v, i) => `${i + 1}`);
    return static58Characters.map(id => ({
        id: id
    }));
...
const page = async ({ params }: Props) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center text-slate-700">
            <div className="relative flex flex-col items-center rounded-[40px] border border-green-600 w-[900px] max-w-[95%] mx-auto bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 p-3">
                ...
                <div className="flex flex-col mt-4 items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
